...
/***/ function(module, exports, __webpack_require__) {
	...
	var _staticImagesTextPng = __webpack_require__(174);

	var _staticImagesTextPng2 = _interopRequireDefault(_staticImagesTextPng);

	var _staticImagesInputBgPng = __webpack_require__(175);

	var _staticImagesInputBgPng2 = _interopRequireDefault(_staticImagesInputBgPng);

	var _staticImagesLinePng = __webpack_require__(176);

	var _staticImagesLinePng2 = _interopRequireDefault(_staticImagesLinePng);

	var _staticImagesGanenPng = __webpack_require__(177);

	var _staticImagesGanenPng2 = _interopRequireDefault(_staticImagesGanenPng);

	var _staticImagesFatherPng = __webpack_require__(178);

	var _staticImagesFatherPng2 = _interopRequireDefault(_staticImagesFatherPng);

	var _staticComponentsFButtonJsx = __webpack_require__(179);

	var _staticComponentsFButtonJsx2 = _interopRequireDefault(_staticComponentsFButtonJsx);

	var _staticComponentsFPhotoJsx = __webpack_require__(190);

	var _staticComponentsFPhotoJsx2 = _interopRequireDefault(_staticComponentsFPhotoJsx);

	var _staticComponentsFStripeJsx = __webpack_require__(195);

	var _staticComponentsFStripeJsx2 = _interopRequireDefault(_staticComponentsFStripeJsx);

	var _staticComponentsFLoadingJsx = __webpack_require__(198);

	var _staticComponentsFLoadingJsx2 = _interopRequireDefault(_staticComponentsFLoadingJsx);

	var _staticJsPubsub = __webpack_require__(182);

	var _staticJsPubsub2 = _interopRequireDefault(_staticJsPubsub);

	var _staticComponentsFIndexPageJsx = __webpack_require__(201);

	var _staticComponentsFIndexPageJsx2 = _interopRequireDefault(_staticComponentsFIndexPageJsx);

	var _iscroll = __webpack_require__(183);

	var _iscroll2 = _interopRequireDefault(_iscroll);

	var path = './static/js/';

	var text = path + _staticImagesTextPng2['default'];

	var inputBg = path + _staticImagesInputBgPng2['default'];

	var ganen = path + _staticImagesGanenPng2['default'];

	var father = path + _staticImagesFatherPng2['default'];
	...
	var App = (function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            window.iscroll = new _iscroll2['default']('.f-main-ui');
	            ...
	            var img = new Image();
	            img.onload = function () {
	                var dots = _this.imgOnload(img, context);

	                var FCircle = (function () {
	                    function FCircle(opts) {
	                        _classCallCheck(this, FCircle);
	        ...
	        key: 'imgOnload',
	        value: function imgOnload(img, context) {
	            ...
	            for (var _i = 0, w = imgData.width; _i < w; _i += gap) {
	                for (var j = 0, h = imgData.height; j < h; j += gap) {
	                    var a = (_i + j * width) * 4;
...
/***/ function(module, exports) {
	...
	var Zepto = (function () {
	  function v(n) {
	    ...
	    var t, i;return rt[n] || (t = u.createElement(n), u.body.appendChild(t), i = getComputedStyle(t, "").getPropertyValue("display"), t.parentNode.removeChild(t), "none" == i && (i = "block"), rt[n] = i), rt[n];
	  }function ct(t) {
	    ...
	    var i = n.className,
	        u = i && i.baseVal !== r;return t === r ? u ? i.baseVal : i : void (u ? i.baseVal = t : n.className = t);
	  }function at(t) {
	    var i;try {
	    ...
	    t(n);for (var i in n.childNodes) vt(n.childNodes[i], t);
	  }var r,
	      i,
	      n,
	      o,
	      ...
	      rt = {},
	      ut = {},
	      ni = { "column-count": 1, columns: 1, "font-weight": 1, "line-height": 1, opacity: 1, "z-index": 1, zoom: 1 },
	      ft = /^\s*<(\w+|!)[^>]*>/,
	      ti = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
	      ...
	      wt = { tr: u.createElement("tbody"), tbody: et, thead: et, tfoot: et, td: pt, th: pt, "*": u.createElement("div") },
	      ...
	      si = { tabindex: "tabIndex", readonly: "readOnly", "for": "htmlFor", "class": "className", maxlength: "maxLength", cellspacing: "cellSpacing", cellpadding: "cellPadding", rowspan: "rowSpan", colspan: "colSpan", usemap: "useMap", frameborder: "frameBorder", contenteditable: "contentEditable" },
	      l = Array.isArray || function (n) {
	    return n instanceof Array;
	  };return t.matches = function (n, i) {
	    var u, e, r, f;return !i || !n || 1 !== n.nodeType ? !1 : (u = n.webkitMatchesSelector || n.mozMatchesSelector || n.oMatchesSelector || n.matchesSelector, u) ? u.call(n, i) : (r = n.parentNode, f = !r, f && (r = bt).appendChild(n), e = ~t.qsa(r, i).indexOf(n), f && bt.removeChild(n), e);
	  }, d = function (n) {
	    ...
	    var e, s, o;return ti.test(t) && (e = n(u.createElement(RegExp.$1))), e || (t.replace && (t = t.replace(ii, "<$1><\/$2>")), i === r && (i = ft.test(t) && RegExp.$1), i in wt || (i = "*"), o = wt[i], o.innerHTML = "" + t, e = n.each(h.call(o.childNodes), function () {
	      o.removeChild(this);
	    ...
	    var e;if (!i) return t.Z();if ("string" == typeof i) if ((i = i.trim(), "<" == i[0] && ft.test(i))) e = t.fragment(i, RegExp.$1, f), i = null;else {
	      if (f !== r) return n(f).find(i);e = t.qsa(u, i);
	    } else {
	      if (s(i)) return n(u).ready(i);if (t.isZ(i)) return i;if (l(i)) e = kt(i);else if (a(i)) e = [i], i = null;else if (ft.test(i)) e = t.fragment(i.trim(), RegExp.$1, f), i = null;else {
	        if (f !== r) return n(f).find(i);e = t.qsa(u, i);
	      }
	    }return t.Z(e, i);
	  }, n = function (n, i) {
	    ...
	    var t,
	        i = h.call(arguments, 1);return "boolean" == typeof n && (t = n, n = i.shift()), i.forEach(function (i) {
	      lt(n, i, t);
	    }), n;
	  }, t.qsa = function (n, t) {
	    var u,
	        ...
	        f = !i && "." == t[0],
	        r = i || f ? t.slice(1) : t,
	        e = ei.test(r);return b(n) && e && i ? (u = n.getElementById(r)) ? [u] : [] : 1 !== n.nodeType && 9 !== n.nodeType ? [] : h.call(e && !i ? f ? n.getElementsByClassName(r) : n.getElementsByTagName(t) : n.querySelectorAll(t));
	    ...
	    var i,
	        r,
	        u,
	        f = [];if (tt(n)) for (r = 0; r < n.length; r++) i = t(n[r], r), null != i && f.push(i);else for (u in n) i = t(n[u], u), null != i && f.push(i);return dt(f);
	  }, n.each = function (n, t) {
	    var i, r;if (tt(n)) {
	      for (i = 0; i < n.length; i++) if (t.call(n[i], i, n[i]) === !1) return n;
	    } else for (r in n) if (t.call(n[r], r, n[r]) === !1) return n;return n;
	  }, n.grep = function (n, t) {
	    return w.call(n, t);
	    ...
	    ot["[object " + t + "]"] = t.toLowerCase();
	  }), n.fn = { forEach: f.forEach, reduce: f.reduce, push: f.push, sort: f.sort, indexOf: f.indexOf, concat: f.concat, map: function map(t) {
	      ...
	      var i = [],
	          u;return s(t) && t.call !== r ? this.each(function (n) {
	      ...
	      var t = this[0];return t && !a(t) ? t : n(t);
	    }, last: function last() {
	      var t = this[this.length - 1];return t && !a(t) ? t : n(t);
	    }, find: function find(i) {
	      var r = this;return "object" == typeof i ? n(i).filter(function () {
	        var t = this;return f.some.call(r, function (i) {
	          return n.contains(i, t);
	        });
	      }) : 1 == this.length ? n(t.qsa(this[0], i)) : this.map(function () {
	        return t.qsa(this, i);
	      });
	    }, closest: function closest(i, r) {
	      var u = this[0],
	          f = !1;for ("object" == typeof i && (f = n(i)); u && !(f ? f.indexOf(u) >= 0 : t.matches(u, i));) u = u !== r && !b(u) && u.parentNode;return n(u);
	      ...
	      return this.each(function () {
	        "none" == this.style.display && (this.style.display = "");"none" == getComputedStyle(this, "").getPropertyValue("display") && (this.style.display = gt(this.nodeName));
	      });
	    }, replaceWith: function replaceWith(n) {
	      return this.before(n).remove();
	    }, wrap: function wrap(t) {
	      var r = s(t),
	          i,
	          u;return this[0] && !r && (i = n(t).get(0), u = i.parentNode || this.length > 1), this.each(function (f) {
	        n(this).wrapAll(r ? t.call(this, f) : u ? i.cloneNode(!0) : i);
	      });
	    }, wrapAll: function wrapAll(t) {
	      if (this[0]) {
	        n(this[0]).before(t = n(t));for (var i; (i = t.children()).length;) t = i.first();n(t).append(this);
	      }return this;
	    }, wrapInner: function wrapInner(t) {
	      var i = s(t);return this.each(function (r) {
	        var u = n(this),
	            f = u.contents(),
	            e = i ? t.call(this, r) : t;f.length ? f.wrapAll(e) : u.append(e);
	      });
	      ...
	      return this.each(function () {
	        var i = n(this);(t === r ? "none" == i.css("display") : t) ? i.show() : i.hide();
	      });
	      ...
	      return 0 === arguments.length ? this.length > 0 ? this[0].innerHTML : null : this.each(function (i) {
	        var r = this.innerHTML;n(this).empty().append(e(this, t, i, r));
	      });
	      ...
	      var u;return "string" == typeof n && t === r ? 0 == this.length || 1 !== this[0].nodeType ? r : "value" == n && "INPUT" == this[0].nodeName ? this.val() : !(u = this[0].getAttribute(n)) && n in this[0] ? this[0][n] : u : this.each(function (r) {
	        if (1 === this.nodeType) if (a(n)) for (i in n) it(this, i, n[i]);else it(this, n, e(this, t, r, this.getAttribute(n)));
	      });
	    }, removeAttr: function removeAttr(n) {
	      return this.each(function () {
	        1 === this.nodeType && it(this, n);
	      });
	    }, prop: function prop(n, t) {
	      return n = si[n] || n, t === r ? this[0] && this[0][n] : this.each(function (i) {
	        this[n] = e(this, t, i, this[n]);
	      });
	    }, data: function data(n, t) {
	      var i = this.attr("data-" + n.replace(ri, "-$1").toLowerCase(), t);return null !== i ? at(i) : r;
	    }, val: function val(t) {
	      ...
	      if (t) return this.each(function (i) {
	        var r = n(this),
	            ...
	            o = { top: u.top - f.top, left: u.left - f.left };"static" == r.css("position") && (o.position = "relative");r.css(o);
	      });if (0 == this.length) return null;var i = this[0].getBoundingClientRect();return { left: i.left + window.pageXOffset, top: i.top + window.pageYOffset, width: Math.round(i.width), height: Math.round(i.height) };
	    }, css: function css(t, r) {
	      var u, e, o, f;if (arguments.length < 2) {
	        if ((u = this[0], e = getComputedStyle(u, ""), !u)) return;if ("string" == typeof t) return u.style[d(t)] || e.getPropertyValue(t);if (l(t)) return o = {}, n.each(l(t) ? t : [t], function (n, t) {
	      ...
	      return t ? this.each(function (i) {
	        o = [];var r = c(this),
	            u = e(this, t, i, r);u.split(/\s+/g).forEach(function (t) {
	          n(this).hasClass(t) || o.push(t);
	        }, this);o.length && c(this, r + (r ? " " : "") + o.join(" "));
	      }) : this;
	      ...
	      return t ? this.each(function (u) {
	        var f = n(this),
	            o = e(this, t, u, c(this));o.split(/\s+/g).forEach(function (n) {
	          (i === r ? !f.hasClass(n) : i) ? f.addClass(n) : f.removeClass(n);
	        });
	      }) : this;
	    }, scrollTop: function scrollTop(n) {
	      if (this.length) {
	        var t = ("scrollTop" in this[0]);return n === r ? t ? this[0].scrollTop : this[0].pageYOffset : this.each(t ? function () {
	          this.scrollTop = n;
	        } : function () {
	      ...
	      if (this.length) {
	        var t = ("scrollLeft" in this[0]);return n === r ? t ? this[0].scrollLeft : this[0].pageXOffset : this.each(t ? function () {
	          this.scrollLeft = n;
	        } : function () {
	      ...
	      if (this.length) {
	        var u = this[0],
	            t = this.offsetParent(),
	            i = this.offset(),
	            r = yt.test(t[0].nodeName) ? { top: 0, left: 0 } : t.offset();return i.top -= parseFloat(n(u).css("margin-top")) || 0, i.left -= parseFloat(n(u).css("margin-left")) || 0, r.top += parseFloat(n(t[0]).css("border-top-width")) || 0, r.left += parseFloat(n(t[0]).css("border-left-width")) || 0, { top: i.top - r.top, left: i.left - r.left };
	      }
	    }, offsetParent: function offsetParent() {
	      return this.map(function () {
	        for (var t = this.offsetParent || u.body; t && !yt.test(t.nodeName) && "static" == n(t).css("position");) t = t.offsetParent;return t;
	      });
	    ...
	    var i = t.replace(/./, function (n) {
	      ...
	      var o,
	          f = this[0];return u === r ? nt(f) ? f["inner" + i] : b(f) ? f.documentElement["scroll" + i] : (o = this.offset()) && o[t] : this.each(function (i) {
	        f = n(this);f.css(t, e(this, u, i, f[t]()));
	      });
	    };
	  }), ["after", "prepend", "before", "append"].forEach(function (i, r) {
	    var u = r % 2;n.fn[i] = function () {
	      var i,
	          f,
	          e = n.map(arguments, function (n) {
	        return i = v(n), "object" == i || "array" == i || null == n ? n : t.fragment(n);
	      }),
	          o = this.length > 1;return e.length < 1 ? this : this.each(function (t, i) {
	        f = u ? i : i.parentNode;i = 0 == r ? i.nextSibling : 1 == r ? i.firstChild : 2 == r ? i : null;e.forEach(function (t) {
	          if (o) t = t.cloneNode(!0);else if (!f) return n(t).remove();vt(f.insertBefore(t, i), function (n) {
	...
	})();window.Zepto = Zepto;void 0 === window.$ && (window.$ = Zepto), (function (n) {
	  function i(n) {
	    return n._zid || (n._zid = nt++);
	  }function c(n, t, r, u) {
	    if ((t = l(t), t.ns)) var f = g(t.ns);return (o[i(n)] || []).filter(function (n) {
	      return !(!n || t.e && n.e != t.e || t.ns && !f.test(n.ns) || r && i(n.fn) !== i(r) || u && n.sel != u);
	    });
	  }function l(n) {
	    var t = ("" + n).split(".");return { e: t[0], ns: t.slice(1).sort().join(" ") };
	  }function g(n) {
	    ...
	    var p = i(t),
	        w = o[p] || (o[p] = []);u.split(/\s/).forEach(function (i) {
	      var u, o;if ("ready" == i) return n(document).ready(e);u = l(i);u.fn = e;u.sel = h;u.e in k && (e = function (t) {
	        var i = t.relatedTarget;if (!i || i !== this && !n.contains(this, i)) return u.fn.apply(this, arguments);
	      });u.del = c;o = c || e;u.proxy = function (n) {
	        if ((n = f(n), !n.isImmediatePropagationStopped())) {
	          n.data = s;var i = o.apply(t, n._args == r ? [n] : [n].concat(n._args));return i === !1 && (n.preventDefault(), n.stopPropagation()), i;
	        }
	      };u.i = w.length;w.push(u);"addEventListener" in t && t.addEventListener(v(u.e), u.proxy, a(u, y));
	    });
	  }function s(n, t, r, u, f) {
	    var e = i(n);(t || "").split(/\s/).forEach(function (t) {
	      c(n, t, r, u).forEach(function (t) {
	        delete o[e][t.i];"removeEventListener" in n && n.removeEventListener(v(t.e), t.proxy, a(t, f));
	      });
	    });
	  }function f(t, i) {
	    return (i || !t.isDefaultPrevented) && (i || (i = t), n.each(rt, function (n, r) {
	      var u = i[n];t[n] = function () {
	    ...
	    var t,
	        i = { originalEvent: n };for (t in n) it.test(t) || n[t] === r || (i[t] = n[t]);return f(i, n);
	  }var r,
	      nt = 1,
	    ...
	    return "string" == typeof n;
	      ...
	      k = { mouseenter: "mouseover", mouseleave: "mouseout" };u.click = u.mousedown = u.mouseup = u.mousemove = "MouseEvents";n.event = { add: y, remove: s };n.proxy = function (r, u) {
	    if (e(r)) {
	      var f = function f() {
	        return r.apply(u, arguments);
	      };return f._zid = i(r), f;
	    }if (t(u)) return n.proxy(r[u], r);throw new TypeError("expected function");
	    ...
	    return !1;
	      ...
	      rt = { preventDefault: "isDefaultPrevented", stopImmediatePropagation: "isImmediatePropagationStopped", stopPropagation: "isPropagationStopped" };n.fn.delegate = function (n, t, i) {
	    ...
	    var l,
	        v,
	        a = this;return i && !t(i) ? (n.each(i, function (n, t) {
	      a.on(n, u, f, t, c);
	      ...
	      c && (l = function (n) {
	        ...
	        var f,
	            i = n(t.target).closest(u, r).get(0);if (i && i !== r) return f = n.extend(p(t), { currentTarget: i, liveFired: r }), (l || o).apply(i, [f].concat(tt.call(arguments, 1)));
	      });y(r, i, o, f, u, v || l);
	    }));
	  };n.fn.off = function (i, u, f) {
	    var o = this;return i && !t(i) ? (n.each(i, function (n, t) {
	      o.off(n, u, t);
	    ...
	    var u, f;return this.each(function (e, o) {
	      u = p(t(i) ? n.Event(i) : i);u._args = r;u.target = o;n.each(c(o, i.type || i), function (n, t) {
	    ...
	    var e, o, r;if ((t(n) || (i = n, n = i.type), e = document.createEvent(u[n] || "Events"), o = !0, i)) for (r in i) "bubbles" == r ? o = !!i[r] : e[r] = i[r];return e.initEvent(n, o, !0), f(e);
	  };
	})(Zepto), (function (n) {
	  function w(t, i, r) {
	    var u = n.Event(i);return n(t).trigger(u, r), !u.isDefaultPrevented();
	  }function i(n, t, i, r) {
	    ...
	    var r = t.context;return t.beforeSend.call(r, n, t) === !1 || i(t, r, "ajaxBeforeSend", [n, t]) === !1 ? !1 : void i(t, r, "ajaxSend", [n, t]);
	  }function l(n, t, r, u) {
	    var f = r.context,
	        e = "success";r.success.call(f, n, e, t);u && u.resolveWith(f, [n, e, t]);i(r, f, "ajaxSuccess", [t, r, n]);a(e, t, r);
	  }function u(n, t, r, u, f) {
	    var e = u.context;u.error.call(e, r, t, n);f && f.rejectWith(e, [r, t, n]);i(u, e, "ajaxError", [r, u, n || t]);a(t, r, u);
	  }function a(n, t, r) {
	    var u = r.context;r.complete.call(u, t, n);i(r, u, "ajaxComplete", [t, r]);k(r);
	  }function r() {}function d(n) {
	    return n && (n = n.split(";", 2)[0]), n && (n == p ? "html" : n == y ? "json" : it.test(n) ? "script" : rt.test(n) && "xml") || "text";
	  }function o(n, t) {
	    return "" == t ? n : (n + "&" + t).replace(/[&?]{1,2}/, "?");
	  }function g(t) {
	    t.processData && t.data && "string" != n.type(t.data) && (t.data = n.param(t.data, t.traditional));!t.data || t.type && "GET" != t.type.toUpperCase() || (t.url = o(t.url, t.data), t.data = void 0);
	  }function f(t, i, r, u) {
	    return n.isFunction(i) && (u = r, r = i, i = void 0), n.isFunction(r) || (u = r, r = void 0), { url: t, data: i, success: r, dataType: u };
	  }function v(t, i, r, u) {
	    var f,
	        e = n.isArray(i),
	        o = n.isPlainObject(i);n.each(i, function (i, s) {
	      f = n.type(s);u && (i = r ? u : u + "[" + (o || "object" == f || "array" == f ? i : "") + "]");!u && e ? t.add(s.name, s.value) : "array" == f || !r && "object" == f ? v(t, s, r, i) : t.add(i, s);
	    });
	  }var e,
	      t,
	      nt = 0,
	      ...
	      p = "text/html",
	      ut = /^\s*$/,
	      h;n.active = 0;n.ajaxJSONP = function (t, i) {
	    if (!("type" in t)) return n.ajax(t);var r,
	        y,
	        a = t.jsonpCallback,
	      ...
	      n(e).triggerHandler("error", t || "abort");
	        ...
	        f = { abort: v };return i && i.promise(f), n(e).on("load error", function (s, c) {
	      clearTimeout(y);n(e).off().remove();"error" != s.type && r ? l(r[0], f, t, i) : u(null, c || "error", f, t, i);window[o] = h;r && n.isFunction(h) && h(r[0]);h = r = void 0;
	    }), c(f, t) === !1 ? (v("abort"), f) : (window[o] = function () {
	      r = arguments;
	    }, e.src = t.url.replace(/\?(.+)=\?/, "?$1=" + o), s.head.appendChild(e), t.timeout > 0 && (y = setTimeout(function () {
	      v("timeout");
	    }, t.timeout)), f);
	  };n.ajaxSettings = { type: "GET", beforeSend: r, success: r, error: r, complete: r, context: null, global: !0, xhr: function xhr() {
	      return new window.XMLHttpRequest();
	    }, accepts: { script: "text/javascript, application/javascript, application/x-javascript", json: y, xml: "application/xml, text/xml", html: p, text: "text/plain" }, crossDomain: !1, timeout: 0, processData: !0, cache: !0 };n.ajax = function (i) {
	    var f = n.extend({}, i || {}),
	        h = n.Deferred && n.Deferred(),
	        a,
	        p,
	        nt;for (e in n.ajaxSettings) void 0 === f[e] && (f[e] = n.ajaxSettings[e]);if ((b(f), f.crossDomain || (f.crossDomain = /^([\w-]+:)?\/\/([^\/]+)/.test(f.url) && RegExp.$2 != window.location.host), f.url || (f.url = window.location.toString()), g(f), f.cache === !1 && (f.url = o(f.url, "_=" + Date.now())), a = f.dataType, p = /\?.+=\?/.test(f.url), "jsonp" == a || p)) return p || (f.url = o(f.url, f.jsonp ? f.jsonp + "=?" : f.jsonp === !1 ? "" : "callback=?")), n.ajaxJSONP(f, h);var k,
	        v = f.accepts[a],
	        w = {},
	        y = function y(n, t) {
	      w[n.toLowerCase()] = [n, t];
	        ...
	        s = f.xhr(),
	        it = s.setRequestHeader;if ((h && h.promise(s), f.crossDomain || y("X-Requested-With", "XMLHttpRequest"), y("Accept", v || "*/*"), (v = f.mimeType || v) && (v.indexOf(",") > -1 && (v = v.split(",", 2)[0]), s.overrideMimeType && s.overrideMimeType(v)), (f.contentType || f.contentType !== !1 && f.data && "GET" != f.type.toUpperCase()) && y("Content-Type", f.contentType || "application/x-www-form-urlencoded"), f.headers)) for (t in f.headers) y(t, f.headers[t]);if ((s.setRequestHeader = y, s.onreadystatechange = function () {
	      if (4 == s.readyState) {
	        s.onreadystatechange = r;clearTimeout(k);var t,
	            i = !1;if (s.status >= 200 && s.status < 300 || 304 == s.status || 0 == s.status && "file:" == tt) {
	          a = a || d(f.mimeType || s.getResponseHeader("content-type"));t = s.responseText;try {
	    ...
	    }, c(s, f) === !1)) return s.abort(), u(null, "abort", s, f, h), s;if (f.xhrFields) for (t in f.xhrFields) s[t] = f.xhrFields[t];nt = "async" in f ? f.async : !0;s.open(f.type, f.url, nt, f.username, f.password);for (t in w) it.apply(s, w[t]);return f.timeout > 0 && (k = setTimeout(function () {
	      s.onreadystatechange = r;s.abort();u(null, "timeout", s, f, h);
	    }, f.timeout)), s.send(f.data ? f.data : null), s;
	  };n.get = function () {
	    return n.ajax(f.apply(null, arguments));
	  };n.post = function () {
	    var t = f.apply(null, arguments);return t.type = "POST", n.ajax(t);
	  };n.getJSON = function () {
	    var t = f.apply(null, arguments);return t.dataType = "json", n.ajax(t);
	  };n.fn.load = function (t, i, r) {
	    if (!this.length) return this;var e,
	        s = this,
	        o = t.split(/\s/),
	        u = f(t, i, r),
	        h = u.success;return o.length > 1 && (u.url = o[0], e = o[1]), u.success = function (t) {
	      s.html(e ? n("<div>").html(t.replace(tt, "")).find(e) : t);h && h.apply(s, arguments);
	    }, n.ajax(u), this;
	  };h = encodeURIComponent;n.param = function (n, t) {
	  ...
	  n.fn.serializeArray = function () {
	    var t,
	        i = [];return n([].slice.call(this.get(0).elements)).each(function () {
	      t = n(this);var r = t.attr("type");"fieldset" != this.nodeName.toLowerCase() && !this.disabled && "submit" != r && "reset" != r && "button" != r && ("radio" != r && "checkbox" != r || this.checked) && i.push({ name: t.attr("name"), value: t.val() });
	    }), i;
	  };n.fn.serialize = function () {
	    var n = [];return this.serializeArray().forEach(function (t) {
	    ...
	    if (t) this.bind("submit", t);else if (this.length) {
	      var i = n.Event("submit");this.eq(0).trigger(i);i.isDefaultPrevented() || this.get(0).submit();
	    }return this;
	  };
	})(Zepto), (function (n) {
	  "__proto__" in {} || n.extend(n.zepto, { Z: function Z(t, i) {
	    ...
	    var t = getComputedStyle;window.getComputedStyle = function (n) {
	      try {
	        return t(n);
	      } catch (i) {
	        return null;
	  ...
	  n.fn.swipe = function (t, i, r) {
	    if (this.size() <= 0) return !1;this[0].listener = this[0].listener || {};this[0].listener[t] = this[0].listener[t] || [];this[0].listener[t].push(i);var u = this[0],
	        o = this,
	        f = ("ontouchstart" in window),
	        s = f ? "touchstart" : "mousedown",
	        h = f ? "touchmove" : "mousemove",
	        c = f ? "touchend" : "mouseup",
	        e = n.extend({ disX: 50, disY: 50, responseTime: 500, isPreventDefult: !0, className: "" }, r);this.on(s, function (n) {
	      var n = f ? n.changedTouches[0] : n,
	          i = n.pageX,
	          r = n.pageY,
	          s = Date.now();o.on(h, function (n) {
	        var n = f ? n.changedTouches[0] : n,
	            h = n.pageX,
	            c = n.pageY,
	            l = Date.now(),
	            s;if (t.toLowerCase() === "left" && Math.abs((c - r) / (h - i)) <= 1 && i - h > e.disX) for (o.off("touchmove"), s = 0; s < u.listener[t].length; s++) u.listener[t][s] && u.listener[t][s](n, u);else if (t.toLowerCase() === "right" && Math.abs((c - r) / (h - i)) <= 1 && h - i > e.disX) for (o.off("touchmove"), s = 0; s < u.listener[t].length; s++) u.listener[t][s] && u.listener[t][s](n, u);else return n.preventDefault && n.preventDefault(), !1;
	      }).on(c, function (n) {
	        var n = f ? n.changedTouches[0] : n,
	            c = n.pageX,
	            h = n.pageY,
	            l = Date.now(),
	            o;if (!(l - s >= e.responseTime)) switch (t.toLowerCase()) {case "down":
	            if (h - r > e.disY && Math.abs((h - r) / (c - i)) > 1) for (o = 0; o < u.listener[t].length; o++) u.listener[t][o] && u.listener[t][o](n, u);break;case "up":
	            if (r - h > e.disY && Math.abs((h - r) / (c - i)) > 1) for (o = 0; o < u.listener[t].length; o++) u.listener[t][o] && u.listener[t][o](n, u);}
	      });
	    });return this;
	  };
	})(Zepto), (function (n) {
	  n.fn.tap = function (t, i) {
	    var h = n.extend({ resposetime: 500 }, i),
	        f = 0,
	        e = 0,
	        o = 0,
	        ...
	        s,
	        r,
	        u;if (c) if ((s = this.attr("id") || "", this[0].listener = this[0].listener || {}, this[0].listener.tap = this[0].listener.tap || [], this[0].listener.type = this[0].listener.type || [], this[0].listener.tap.push(t), this[0].listener.type.push(s), r = this[0], arguments.length === 0)) for (u = 0; u < this[0].listener.type.length; u++) this.attr("id") === this[0].listener.type[u] && r.listener.tap[u] && r.listener.tap[u]();else return this.each(function () {
	      n(this).on("touchstart", function (n) {
	        n = n.changedTouches[0];e = n.pageX;o = n.pageY;f = Date.now();
	      }).on("touchend", function (n) {
	        var c = Date.now(),
	            u,
	            s,
	            i;if ((n = n.changedTouches[0], u = n.pageX, s = n.pageY, c - f <= h.resposetime && Math.abs(s - o) < 6 && Math.abs(u - e) < 6 && t)) for (i = 0; i < r.listener.tap.length; i++) r.listener.tap[i] && r.listener.tap[i](n, this);
	      });
	    });else this.on("click", function (n) {
	      t && t(n, this);
	    });return this;
	  };
	})(Zepto);!(function (n) {
	  function t(t) {
	    this.slider = t && t.slider ? t.slider : {};this.transY = 0;this.callback = t && t.callback ? t.callback : function () {};this.isEnableDefaultMove = t && t.isEnableDefaultMove ? t.isEnableDefaultMove : !0;this.isNeedProcess = t.isNeedProcess === undefined ? !0 : t.isNeedProcess;this.bindMoveEventObj = t.bindMoveEventObj || this.slider.parent();this.slipping(this);this.barHeight = t.barHeight;this.ps = n(".ps");
	  }n.fn.slider = function (i) {
	    var u = { fnMove: function fnMove() {}, isNeedProcess: !0, bindMoveEventObj: {} },
	        r = n.extend(u, i);new t({ slider: this, callback: function callback(n) {
	        r.fnMove(n);
	      }, isNeedProcess: r.isNeedProcess, bindMoveEventObj: r.bindMoveEventObj });
	  };t.prototype.creatScrollBar = function (t) {
	    var r = this.slider.height(),
	        t = this.slider.parent().height(),
	        i = "";i = "<style>.ps{position:absolute;right:0%;height:" + t + "px;width:2px;background:#f90;top:0;opacity:0;-webkit-transition:400ms opacity;}                 .cs{position:absolute;top:0;height:" + t * t / r + "px;width:2px;background:green;}                <\/style>";n("head").append(i);this.slider.parent().css({ position: "absolute" }).append("<div class='ps'><div class='cs'><\/div><\/div>");
	  };t.prototype.slipping = function (t) {
	    var i = t,
	        u,
	        r;if ((i.isEnableDefaultMove && n(document).on("touchmove", function (n) {
	      n.preventDefault && n.preventDefault();
	    }), u = i.slider.offset().height, r = i.slider.parent().offset().height, !(r - u >= 0))) {
	      i.isNeedProcess && this.creatScrollBar(r);i.iSpeedY = 0;i.slider.on("touchstart mousedown", function (t) {
	        var f, t, e;i.ps.css({ opacity: 1 });f = i.transY;i.slider.css("-webkit-transition", "none");t = t.changedTouches ? t.changedTouches[0] : t;e = t.pageY;i.lastY = t.pageY;i.bindMoveEventObj.on("touchmove mousemove", function (n) {
	          var o;n.preventDefault && n.preventDefault();var n = n.changedTouches ? n.changedTouches[0] : n,
	              s = n.pageY,
	              t = s - e + f;return t >= 0 ? t = 0 : t <= r - u && (t = r - u), i.slider.css("-webkit-transform", "translate3d(0," + t + "px,0)"), i.transY = t, i.iSpeedY = n.pageY - i.lastY, i.lastY = n.pageY, o = i.transY / (r - u), i.slider.parent().find(".cs").css("-webkit-transform", "translate3d(0," + (r - r * r / u) * o + "px,0)"), i.callback && i.callback(t), !1;
	        }).on("touchend mouseup", function (t) {
	          i.ps.css({ opacity: 0 });n(this).off("touchend touchmove mousemove mouseup");var t = t.changedTouches ? t.changedTouches[0] : t,
	              s = t.pageY,
	              o = s - e + f + i.iSpeedY * 14;o >= 0 ? o = 0 : o <= r - u && (o = r - u);i.slider.css("-webkit-transition", "-webkit-transform " + Math.abs(i.iSpeedY) * 30 + "ms ease");i.slider.css("-webkit-transform", "translate3d(0," + o + "px,0)");i.transY = o;
	        });
	      });
	    }
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "736ee407589e4eb30b45c474b0cafbd7.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "0efce9fc70373730a4735020b7017747.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "aa796abbf043abb3788997cc7b6526dc.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "adfa460921614c9f912b55685a009344.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsPubsub = __webpack_require__(182);

	var _jsPubsub2 = _interopRequireDefault(_jsPubsub);
	...
	var FButton = (function (_React$Component) {
	    _inherits(FButton, _React$Component);

	    function FButton(args) {
	        _classCallCheck(this, FButton);

	        _get(Object.getPrototypeOf(FButton.prototype), 'constructor', this).apply(this, args);
	    ...
	    _createClass(FButton, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement('div', { ref: this.props.r, className: 'f-button-group', style: { display: this.state.display } }, _react2['default'].createElement('div', { ref: 'btn1', style: btn1Style, onTouchEnd: this.touchEnd, className: 'f-button1',
	                onTouchTap: this.uploadImage, onTouchStart: this.touchStart }, this.state.content), _react2['default'].createElement('div', { className: 'f-button2', style: btn2Style }, this.state.content), _react2['default'].createElement('input', { type: 'file', ref: 'f-file', style: { opacity: 0, position: 'fixed', zIndex: -1 },
	        ...
	        value: function onChange() {
	            ...
	            _jsPubsub2['default'].publish('start');
	            var formData = new FormData();
	            if (this.refs['f-file'].files.length <= 0) {
	                return;
	            }

	            var file = this.refs['f-file'].files[0];
	            ...
	            $.ajax({
	                ...
	                success: function success(data) {
	                    ...
	                    if (data.getret === 0) {
	                        var url = 'http://webapi.zmiti.com/' + data.geturl[0];
	                        ...
	                        img.onload = function () {
	                            ...
	                            setTimeout(function () {
	                                ...
	                                _jsPubsub2['default'].publish('stop');
	                            }, 1);
	                        };
	                        img.src = url;
	                    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
		// When the styles change, update the <style> tags
		if (!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./f-button.css", function () {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./f-button.css");
				if (typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {var invariant = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _imagesPhotobgPng = __webpack_require__(193);

	var _imagesPhotobgPng2 = _interopRequireDefault(_imagesPhotobgPng);

	var _imagesTapePng = __webpack_require__(194);

	var _imagesTapePng2 = _interopRequireDefault(_imagesTapePng);

	var FPhoto = (function (_React$Component) {
	    _inherits(FPhoto, _React$Component);

	    function FPhoto(args) {
	        _classCallCheck(this, FPhoto);

	        _get(Object.getPrototypeOf(FPhoto.prototype), 'constructor', this).apply(this, args);
	        this.state = {
	    ...
	    _createClass(FPhoto, [{
	        key: 'changeFatherPhoto',
	        value: function changeFatherPhoto(fatherPhoto) {
	            this.setState({
	        ...
	        value: function componentDidMount() {
	            ...
	            _jsPubsub2['default'].subscribe('changeFatherPhoto', function (b, a) {
	                if (a.type === _this.props.type) {
	                    _this.changeFatherPhoto(a.url);
	                }
	            });
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            var style = {
	                background: 'url(' + _imagesPhotobgPng2['default'] + ') repeat center center',
	                display: this.state.display
	            };
	            return _react2['default'].createElement('figure', { className: 'f-photo-C', style: style }, _react2['default'].createElement('img', { src: this.state.fatherPhoto, alt: '' }), _react2['default'].createElement('figcaption', { className: 'f-tape' }, _react2['default'].createElement('img', { src: _imagesTapePng2['default'], alt: '', draggable: 'false' })), _react2['default'].createElement('figcaption', { className: 'f-tape' }, _react2['default'].createElement('img', { src: _imagesTapePng2['default'], alt: '', draggable: 'false' })));
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
		// When the styles change, update the <style> tags
		if (!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./f-photo.css", function () {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./f-photo.css");
				if (typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FStripe = (function (_React$Component) {
	    _inherits(FStripe, _React$Component);

	    function FStripe(args) {
	        _classCallCheck(this, FStripe);

	        _get(Object.getPrototypeOf(FStripe.prototype), 'constructor', this).apply(this, args);
	    }

	    _createClass(FStripe, [{
	        key: 'render',
	        value: function render() {
	            return _react2['default'].createElement('div', { className: 'f-stripe ' + this.props.des });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
		// When the styles change, update the <style> tags
		if (!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./f-stripe.css", function () {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./f-stripe.css");
				if (typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FLoading = (function (_React$Component) {
	    _inherits(FLoading, _React$Component);

	    function FLoading(args) {
	        _classCallCheck(this, FLoading);

	        _get(Object.getPrototypeOf(FLoading.prototype), 'constructor', this).apply(this, args);
	        this.state = {
	            starting: false
	        };
	    }

	    _createClass(FLoading, [{
	        key: 'start',
	        ...
	        value: function componentDidMount() {
	            ...
	            _jsPubsub2['default'].subscribe("start", function () {
	                _this2.start();
	            });

	            _jsPubsub2['default'].subscribe('stop', function () {
	                _this2.stop();
	            });
	        }
	    }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
		// When the styles change, update the <style> tags
		if (!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./f-loading.css", function () {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./f-loading.css");
				if (typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _imagesIndexBgPng = __webpack_require__(204);

	var _imagesIndexBgPng2 = _interopRequireDefault(_imagesIndexBgPng);

	var _imagesHeartPng = __webpack_require__(205);

	var _imagesHeartPng2 = _interopRequireDefault(_imagesHeartPng);

	var _imagesCameraPng = __webpack_require__(206);

	var _imagesCameraPng2 = _interopRequireDefault(_imagesCameraPng);

	var _imagesNecktiePng = __webpack_require__(207);

	var _imagesNecktiePng2 = _interopRequireDefault(_imagesNecktiePng);

	var _imagesFFatherPng = __webpack_require__(208);

	var _imagesFFatherPng2 = _interopRequireDefault(_imagesFFatherPng);

	var _imagesLovePng = __webpack_require__(209);

	var _imagesLovePng2 = _interopRequireDefault(_imagesLovePng);

	var _imagesLogoPng = __webpack_require__(210);

	var _imagesLogoPng2 = _interopRequireDefault(_imagesLogoPng);

	var _imagesFFatherTextPng = __webpack_require__(211);

	var _imagesFFatherTextPng2 = _interopRequireDefault(_imagesFFatherTextPng);

	var _jsTween = __webpack_require__(212);

	var _jsTween2 = _interopRequireDefault(_jsTween);

	var _jsRequestAnimationFrame = __webpack_require__(213);

	var _jsRequestAnimationFrame2 = _interopRequireDefault(_jsRequestAnimationFrame);

	var _utilMethodEs6 = __webpack_require__(172);

	var path = './static/js/';
	var indexBg = path + _imagesIndexBgPng2['default'];

	var heart = path + _imagesHeartPng2['default'];

	var camera = path + _imagesCameraPng2['default'];

	var necktie = path + _imagesNecktiePng2['default'];

	var ffather = path + _imagesFFatherPng2['default'];

	var love = path + _imagesLovePng2['default'];

	var logo = _imagesLogoPng2['default'];

	var ftext = path + _imagesFFatherTextPng2['default'];

	var imgArr = [indexBg, heart, camera, necktie, ffather, love, logo, ftext];

	_utilMethodEs6.utilMethods.loading(imgArr, null, function () {
	    loaded();
	});

	var FIndexPage = (function (_React$Component) {
	    _inherits(FIndexPage, _React$Component);

	    function FIndexPage(args) {
	        _classCallCheck(this, FIndexPage);

	        _get(Object.getPrototypeOf(FIndexPage.prototype), 'constructor', this).apply(this, args);
	    }

	    _createClass(FIndexPage, [{
	        key: 'render',
	        value: function render() {
	            function l() {
	            ...
	            return _react2['default'].createElement('div', { ref: 'index-page', className: 'f-index-page-C', style: style }, _react2['default'].createElement('div', { className: 'f-heart', ref: 'heart' }, _react2['default'].createElement('img', { src: heart, alt: '' })), _react2['default'].createElement('div', { className: 'f-camera', ref: 'camera' }, _react2['default'].createElement('img', { src: camera, alt: '' })), _react2['default'].createElement('div', { className: 'f-necktie', ref: 'necktie' }, _react2['default'].createElement('img', { src: necktie, alt: '' })), _react2['default'].createElement('div', { className: 'f-father-text', ref: 'father-text' }, _react2['default'].createElement('img', { src: ftext, alt: '' })), _react2['default'].createElement('div', { className: 'f-father', ref: 'father' }, _react2['default'].createElement('img', { src: ffather, alt: '' })), _react2['default'].createElement('div', { className: 'f-love', ref: 'love' }, _react2['default'].createElement('img', { src: love, alt: '' })), _react2['default'].createElement('div', { className: 'f-logo', ref: 'logo' }, _react2['default'].createElement('img', { src: logo, alt: '' })));
	        }
	    }, {
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            ...
	            function animate(time) {
	                isStarting && (0, _jsRequestAnimationFrame2['default'])(animate);
	                _jsTween2['default'].update(time);
	            }
	            animate();
	            ...
	            if (!heart.timer) {
	                heart.timer = new _jsTween2['default'].Tween(heart.scale).to({ scale: 1.4 }, 2000).delay(1400).easing(_jsTween2['default'].Easing.Elastic.InOut).onUpdate(function () {
	                ...
	                camera.timer = new _jsTween2['default'].Tween(camera.scale).to({ scale: 1 }, 1000).easing(_jsTween2['default'].Easing.Elastic.InOut).onUpdate(function () {
	                ...
	                fatherText.timer = new _jsTween2['default'].Tween(fatherText.scale).to({ scale: 1 }, 2000).easing(_jsTween2['default'].Easing.Elastic.InOut).onUpdate(function () {
	                ...
	                love.timer = new _jsTween2['default'].Tween(love.X).to({ opacity: 1 }, 3000).easing(_jsTween2['default'].Easing.Elastic.Out).onUpdate(function () {
	                    love.style.opacity = love.X.opacity;
	                }).onComplete(function () {
	                    love.style.opacity = 1;
	                });

	                logo.timer = new _jsTween2['default'].Tween(logo.X).to({ opacity: 1 }, 3000).easing(_jsTween2['default'].Easing.Elastic.InOut).onUpdate(function () {
	            ...
	            $(this.refs['index-page']).swipe('up', function (e, _this) {
	                isStarting = false;
	        ...
	        key: 'setTransform',
	        value: function setTransform(obj, value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
		// When the styles change, update the <style> tags
		if (!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./f-index-page.css", function () {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./f-index-page.css");
				if (typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "452d9d0b8adbd486018cd9efc9f32fca.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "6494c4107266ab70637aaf84fe037c51.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "0b47c8040bdb6051e3239369ab4c515b.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "2726f84f5c020a6d77c527b8ea63d36b.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "4a468dccca0d222e9c879f9e7c1731b3.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "a6d66009897f2f61913f6f1597fd2bbe.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "cbba0b1c9a0abc9b83f4202112b3fb40.png";
