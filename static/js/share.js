...
/***/ function(module, exports, __webpack_require__) {
	...
	var _staticImagesSharePng = __webpack_require__(199);

	var _staticImagesSharePng2 = _interopRequireDefault(_staticImagesSharePng);

	var path = './static/js/';

	var bg = path + _staticImagesSharePng2['default'];
	...
	var App = (function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement('div', { className: 'f-main-ui' }, _react2['default'].createElement('section', { className: 'f-main-content', style: { backgroundColor: '#46a17d', background: 'url(' + bg + ') no-repeat', backgroundSize: 'cover' } }, _react2['default'].createElement('div', { className: 'f-main-text' }, _react2['default'].createElement('p', { className: 'f-main-text-content' }, '父爱，伟岸如青山，圣洁如冰雪，温暖如骄阳，宽广如江海。我在父亲的爱中成长，如今我长大了，我在父亲的爱中成长，如今我长大了，我要用更多的爱来回报你，我最亲爱的老爸')), _react2['default'].createElement('div', null, _react2['default'].createElement('div', { className: 'f-main-img' }, _react2['default'].createElement('figcaption', { className: 'f-tape' }, _react2['default'].createElement('img', { src: 'static/images/tape.png', alt: '' })), _react2['default'].createElement('div', { className: 'f-main-img-item' }, _react2['default'].createElement('div', null, _react2['default'].createElement('img', { src: './static/images/1.png', alt: '' }))), _react2['default'].createElement('div', { className: 'f-main-img-item1' })), _react2['default'].createElement('div', { className: 'f-btn' }, _react2['default'].createElement('div', { className: 'f-button-group' }, _react2['default'].createElement('div', { ref: 'btn1', className: 'f-button1' }, '发送给老爸!'), _react2['default'].createElement('div', { className: 'f-button2' }, '发送给老爸!'))))));
	        }
	    }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "fbb934412463e38f569ac93832cba289.png";
